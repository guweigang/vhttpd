...
- verify no `php/package/bin/php-worker` process is left for this run
...
```bash
PORT=19882 POOL_SIZE=6 bash /Users/guweigang/Source/vhttpd/bench/run_host_regression.sh
```

Skip k6 and only verify lifecycle:

```bash
RUN_K6=0 bash /Users/guweigang/Source/vhttpd/bench/run_host_regression.sh
```

Using unified names:

```bash
VHTTPD_PORT=19882 VHTTPD_WORKER_POOL_SIZE=6 bash /Users/guweigang/Source/vhttpd/bench/run_host_regression.sh
...
```bash
k6 run /Users/guweigang/Source/vhttpd/bench/k6_short.js
```
...
VHTTPD_APP=/Users/guweigang/Source/vhttpd/examples/stream-bench-app.php make serve
```
...
k6 run /Users/guweigang/Source/vhttpd/bench/k6_stream.js
```
