...
- [OVERVIEW.md](file://design-docs/OVERVIEW.md)
- [PROTOCOL_PIPELINE_RELAY_ARCHITECTURE.md](file://design-docs/PROTOCOL_PIPELINE_RELAY_ARCHITECTURE.md)
- [EXECUTOR_MODES.md](file://design-docs/EXECUTOR_MODES.md)
- [RUNTIME_MODULE_MAP.md](file://design-docs/RUNTIME_MODULE_MAP.md)
...
## 更新摘要
**所做更改**   
- 更新了设计文档引用路径，从 `docs/` 目录迁移到 `design-docs/` 目录
- 修正了所有相关的设计文档链接和引用
- 保持了原有的文档结构和内容完整性
