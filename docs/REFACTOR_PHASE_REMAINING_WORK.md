...
- Latest acceptance verification: `make build` and `bash tests/e2e/config_acceptance_test.sh` passed on 2026-07-03 with 152 config-acceptance checks green; `VHTTPD_E2E_DB_LIVE=1 bash tests/e2e/config_acceptance_test.sh` passed on 2026-07-04 with 155 checks green against local MySQL.
