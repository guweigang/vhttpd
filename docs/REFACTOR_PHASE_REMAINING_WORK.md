...
- Latest acceptance verification: `bash tests/e2e/config_acceptance_test.sh` passed on 2026-07-04 with 156 config-acceptance checks green; `VHTTPD_E2E_DB_LIVE=1 VHTTPD_E2E_WP_ROOT=/Users/guweigang/wwwroot/wordpress bash tests/e2e/config_acceptance_test.sh` passed on 2026-07-04 with 168 checks green against local MySQL plus the installed WordPress/WooCommerce site.
