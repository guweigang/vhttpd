...
pub fn OpenAIFrameMapping.from_ndjson_row(line string) OpenAIFrameMapping {
	return extract_mapped_row(line)
}
...
pub fn OpenAIFrameMapping.from_plugin_result(raw string) OpenAIFrameMapping {
...
pub fn OpenAIFrameMapping.executor_stream_mappings(raw string) []OpenAIFrameMapping {
	return executor_stream_mappings(raw)
}
